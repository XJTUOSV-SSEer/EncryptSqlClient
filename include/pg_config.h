...
#define CONFIGURE_ARGS " '--enable-cassert' '--enable-debug' 'CFLAGS=-ggdb -O0 -fno-omit-frame-pointer'"
...
#define PG_VERSION_STR "PostgreSQL 14.12 on aarch64-apple-darwin23.5.0, compiled by Apple clang version 15.0.0 (clang-1500.3.9.4), 64-bit"
